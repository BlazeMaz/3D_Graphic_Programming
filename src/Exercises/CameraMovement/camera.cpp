...
glm::mat4 Camera::projection() const { return glm::perspective(fov_, aspect_, near_, far_); }

glm::vec3 Camera::position() const { return position_; }

glm::vec3 Camera::center() const { return center_; }

glm::vec3 Camera::x() const { return x_; }

glm::vec3 Camera::y() const { return y_; }

glm::vec3 Camera::z() const { return z_; }
