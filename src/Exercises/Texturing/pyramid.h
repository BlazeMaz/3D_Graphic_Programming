...
private:
    ...
    std::vector<GLfloat> vertices = {
            -0.5f, -0.5f, -0.5f, 0.5f, 0.809f, //0
            0.5f, -0.5f, -0.5f, 0.191f, 0.5f, //1
            0.5f, -0.5f, 0.5f, 0.5f, 0.191f, //2
            -0.5f, -0.5f, 0.5f, 0.809f, 0.5f, //3 base

            0.0f, 0.5f, 0.0f, 0.0f, 1.0f, //4
            0.0f, 0.5f, 0.0f, 0.0f, 0.0f, //5
            0.0f, 0.5f, 0.0f, 1.0f, 0.0f, //6
            0.0f, 0.5f, 0.0f, 1.0f, 1.0f, //7
    };
